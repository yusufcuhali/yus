window.GeneralSettingsTab = function GeneralSettingsTab() {
    ...
    return (
        <div className="space-y-6" data-name="general-settings">
            <h2 className="text-2xl font-bold text-white">Genel Ayarlar</h2>
